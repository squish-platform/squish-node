...
class Squish {
    constructor(opts) {
        ...
        this.client = createClient_1.createClient({ token: opts.token, uri: opts.swish.callbackUrl });
    }
    /**
    ...
    subscribe(id, callback) {
        return this.client
            ...
            .subscribe((res) => callback(undefined, handleResponse(res)), (err) => callback(err, undefined));
    }
    /**
     * Pay invoice
     *
